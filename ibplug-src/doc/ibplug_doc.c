/* Main code for IBPlug Doc */

#include <PalmOS.h>
#include "booger.h"

#include "ibplug_docRsc.h"
#include "ibplug_doc.h"
...
PickBooger(KleenexPtr kleenexP)
{
    ...
    /* Load the GoTo parameters.  ('Out of memory' will be handled.) */
...
BlowNose(KleenexPtr kleenexP)
{
    ...
    kleenexP->booger.cmd = (kleenexP->booger.cmdPBP)
                                ? sysAppLaunchCmdGoTo
                                : boogerPlugLaunchCmdLaunchLauncher;
