 ...
 *  Revisions and ARMlet support by Justin Clark (jclark@coopcomp.com) 2003
 */
...
__inline Err SysZLib_OpenLibrary (UInt16 *refNumP)
{
  Err error;
...
__inline Err SysZLib_CloseLibrary (UInt16 refNum)
{
  Err error;
  UInt16 zltmp;
