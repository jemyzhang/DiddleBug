 ...
 *    <HISTORY>                                                               *
 *       Started on   : 00/10/05                                  		   *
 *       Last Modified: $Date: 2003/12/06 14:22:06 $ 
 *                                                                            *
 ******************************************************************************/
...
//-----------------------------------------------------------------------------
	...
	//	//typedef enum {
	//	//	/* MsaIf */
	//#define	msaTrapPlay (sysLibTrapCustom+0) //= sysLibTrapCustom,
	//#define	msaTrapStop (sysLibTrapCustom+1) //
	//#define	msaTrapGetPBPosition (sysLibTrapCustom+2) //
	//#define	msaTrapGetTrackInfo (sysLibTrapCustom+3) //
	//#define	msaTrapGetPBStatus (sysLibTrapCustom+4) //
	//#define	msaTrapSetPBRate (sysLibTrapCustom+5) //
	//#define	msaTrapSetPBPosition (sysLibTrapCustom+6) //
	//#define	msaTrapGetPBRate (sysLibTrapCustom+7) //
	//#define	msaTrapGetPBMode (sysLibTrapCustom+8) //
	//#define	msaTrapGetPBList (sysLibTrapCustom+9) //
	//#define	msaTrapSetPBList (sysLibTrapCustom+10) //
	//#define	msaTrapSetPBStatus (sysLibTrapCustom+11) //
	//#define	msaTrapSetPBMode (sysLibTrapCustom+12) //
	//#define	msaTrapSuToTime (sysLibTrapCustom+13) //
	//#define	msaTrapTimeToSu (sysLibTrapCustom+14) //
	//#define	msaTrapPBListIndexToTrackNo (sysLibTrapCustom+15) //
	//#define	msaTrapGetShufflePlayedList (sysLibTrapCustom+16) //
	//#define	msaTrapGetAlbum (sysLibTrapCustom+17) //
	//#define	msaTrapSetAlbum (sysLibTrapCustom+18) //
	//#define	msaTrapSetControlKey (sysLibTrapCustom+19) //
	//#define	msaTrapEdit (sysLibTrapCustom+20) //
	//#define	msaTrapGetCapability (sysLibTrapCustom+21) //
	//#define	msaTrapGetAPIVersion (sysLibTrapCustom+22) //
	//#define	msaTrapGetTrackRestrictionInfo (sysLibTrapCustom+23) //
	//	//	/* MsaOut */
	//#define	msaTrapOutGetCapability (sysLibTrapCustom+24) //
	//#define	msaTrapOutInit (sysLibTrapCustom+25) //
	//#define	msaTrapOutSetOutputMode (sysLibTrapCustom+26) //
	//#define	msaTrapOutSetVolume (sysLibTrapCustom+27) //
	//#define	msaTrapOutVolumeUp (sysLibTrapCustom+28) //
	//#define	msaTrapOutVolumeDown (sysLibTrapCustom+29) //
	//#define	msaTrapOutSetVolumeLimit (sysLibTrapCustom+30) //
	//#define	msaTrapOutSetMute (sysLibTrapCustom+31) //
	//#define	msaTrapOutSetEQ (sysLibTrapCustom+32) //
	//#define	msaTrapOutSetEQLevel (sysLibTrapCustom+33) //
	//#define	msaTrapOutSetBBLevel (sysLibTrapCustom+34) //
	//#define	msaTrapOutSetBeepLevel (sysLibTrapCustom+35) //
	//#define	msaTrapOutStartBeep (sysLibTrapCustom+36) //
	//#define	msaTrapOutStopBeep (sysLibTrapCustom+37) //
	//#define	msaTrapOutGetVolume (sysLibTrapCustom+38) //
	//#define	msaTrapOutGetVolumeLimit (sysLibTrapCustom+39) //
	//#define	msaTrapOutGetMute (sysLibTrapCustom+40) //
	//#define	msaTrapOutGetEQ (sysLibTrapCustom+41) //
	//#define	msaTrapOutGetEQLevel (sysLibTrapCustom+42) //
	//#define	msaTrapOutGetBBLevel (sysLibTrapCustom+43) //
	//#define	msaTrapOutGetBeepLevel (sysLibTrapCustom+44) //
	//#define	msaTrapOutGetOutputMode (sysLibTrapCustom+45) //
	//#define	msaTrapOutGetInfo (sysLibTrapCustom+46) //
	//#define	msaTrapOutGetLevel (sysLibTrapCustom+47) //
	//#define	msaTrapOutGetSpectrum (sysLibTrapCustom+48) //
	//#define	msaTrapOutGetBeepStatus (sysLibTrapCustom+49) //
	//	//	/* MsaStream */
	//#define	msaTrapStreamOpenStream (sysLibTrapCustom+50) //
	//#define	msaTrapStreamCloseStream (sysLibTrapCustom+51) //
	//#define	msaTrapStreamSetFormat (sysLibTrapCustom+52) //
	//#define	msaTrapStreamPut (sysLibTrapCustom+53) //
	//#define	msaTrapStreamSetCallback (sysLibTrapCustom+54) //
	//#define	msaTrapStreamStartPlay (sysLibTrapCustom+55) //
	//#define	msaTrapStreamStopPlay (sysLibTrapCustom+56) //
	//#define	msaTrapStreamFlush (sysLibTrapCustom+57) //
	//#define	msaTrapStreamGetStatus (sysLibTrapCustom+58) //
	//#define	msaTrapStreamGetTime (sysLibTrapCustom+59) //
	//#define	msaTrapStreamSetFeatureValue (sysLibTrapCustom+60) //
	//#define	msaTrapStreamGetFeatureValue (sysLibTrapCustom+61) //
	//#define	msaTrapStreamReservedFunction (sysLibTrapCustom+62) //
	//#define	msaTrapEnforceOpen (sysLibTrapCustom+63) //
	//#define	msaTrapAlbumEnumarate (sysLibTrapCustom+64) //
	//#define	msaLibLastTrap (sysLibTrapCustom+65) // /* for calculating the number of traps */,
