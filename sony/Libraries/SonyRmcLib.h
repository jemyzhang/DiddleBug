...
//-----------------------------------------------------------------------------
	...
	//typedef enum {
#define	RmcLibTrapRegister (sysLibTrapCustom+0) //
#define	RmcLibTrapDisableKeyHandler (sysLibTrapCustom+1) //
#define	RmcLibTrapEnableKeyHandler (sysLibTrapCustom+2) //
#define	RmcLibTrapGetStatus (sysLibTrapCustom+3) //
#define	RmcLibTrapKeyControl (sysLibTrapCustom+4) //
#define	RmcLibTrapSwitchAdcVal (sysLibTrapCustom+5) //
