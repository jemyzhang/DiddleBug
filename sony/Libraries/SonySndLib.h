...
/************************************************************************/
	//	//typedef enum {
#define	SonySndTrapLibAPIVersion (sysLibTrapCustom+0) //= sysLibTrapCustom,
#define	SonySndTrapEnableNewSoundMgr (sysLibTrapCustom+1) //
#define	SonySndTrapSndPlayPcm (sysLibTrapCustom+2) //
#define	SonySndTrapSndPlayPcmResource (sysLibTrapCustom+3) //
#define	SonySndTrapSndCreatePcmList (sysLibTrapCustom+4) //
	//
#define	SonySndMaxSelector (sysLibTrapCustom+5) //= SonySndTrapSndCreatePcmLis,
	//} SonySndLibSelector;
