 ...
 ******************************************************************************/
/**
 * @defgroup	HsNav 5-Way Navigation Library
 * @brief		This library provides 5-way navigation support for applications
 *				on the Treo 600 devices.
 *
 * The 5-way navigation features and APIs described here have already existed
 * in Palm OS SDK for Palm OS ver. 5.4.1 and above, and applications that are
 * developed for newer devices should be using PalmSource's Palm OS definitions
 * of these features and APIs. Developers can use palmOne defined features to extend
 * support back to Treo 600 devices.
 *
 * For more information on 5-way navigation support, please refer to palmOne
 * Developer Guide and also the Palm OS Documentation.
 *
 * @{
 * @}
 */
...
/**
 * @file	HsNavCommon.h
 * @brief	Public common header file for 5-way navigation support on Treo 600.
 *
 * This file contains the common constant and structures used to support 5-way navigation
 * in an application.
 *
 */
...
#define hsNavFocusRingWidthSingleDensity	3	// Width in single-density coordinates
