 ...
 *
 * $Id: //device/handheld/dev/sdk/2.2.2/incs/common/system/HsChars.h#2 $
 *
 ****************************************************************/
...
#define hsChrOptHard11				  vchrHard12
#define hsChrOptHard13				  vchrHard14
...
// Used to rebroadcast the Send key to invoke the redial list
#define hsChrRedialList                                   0x1621

// Characters in PSI's "hard-key" range.  We've received PSI's permission for these definitions.  PSI
//	will include these definitions in their next 5.x SDK release so we surround these definitions with
//	macros.

#ifndef vchrHard11
#define	vchrHard11					0x021A	
#endif // vchrHard11

#ifndef vchrHard12
#define	vchrHard12					0x021B	// Alternative vchrHard11 action
#endif // vchrHard12

#ifndef vchrHard13
#define	vchrHard13					0x021C	
#endif // vchrHard13

#ifndef vchrHard14
#define	vchrHard14					0x021D	// Alternative vchrHard14 action
#endif // vchrHard14
