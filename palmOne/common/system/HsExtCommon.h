 ...
 *****************************************************************************/
/**
 * @defgroup HSExt Handspring Extensions
 *
 * @{
 * @}
 */
...
#define hsAttrSysActiveProgress	      0x0002    /**< Progress dialog is up (any progress dialog) */
#define hsAttrSysActiveBeamProgress	  0x0004    /**< Beam Progress dialog is up */
/*@{*/
...
typedef enum
  {			
	...
	/**** End of prefs recognized by Treo 650 ****/

	hsPrefHard11CharAppCreator,		  /**< UInt32 : Creator type of app to launch
									  		  in response to vchrHard11 */

	hsPrefOptHard11CharAppCreator,	  /**< UInt32 : Creator type of app to launch
									  		  in response to hsChrOptHard11 */

	hsPrefUserNotLookingTime,			/**< Int32 : After this many seconds since the last
												action, the user has stopped looking 
												at the device. (auto display/kbd dim) */

	// <chg 2005-DEC-14 Monte Benaresh> Added next pref

	hsPrefNetworkTZSelected,			/**< UInt16: used by phones - should it read 
												the time zone from the network*/

	// RJS 22May06 Added next pref for PTT
	hsPrefShortSideHardCharAppCreator,		/**< UInt32: Creator ID of app to launch on short press of side button */

	// RTS April 06 Added pref for Gnome/Gandalf 
	hsPrefPowerSaveMode,			/**< Int32 : tied to the hsPrefUserNotLookingTime to turn off the backlight
							 rather than just dim it.  LCD remains on.*/
...
#define hsHALIDHandspringOs5Rev3	  'P052'	/**< Used by Handspring's 5.3 HALs */
#define hsHALIDHandspringOs5Rev3Sim	  'S052'	/**< Used by Handspring's 5.3 Simulator HALs */

#define hsHALIDHandspringOs5Rev4	  'P053'	/**< Used by Handspring's 5.4 HALs */
#define hsHALIDHandspringOs5Rev4Sim	  'S053'	/**< Used by Handspring's 5.4 Simulator HALs */
/*@}*/
