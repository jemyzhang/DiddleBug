 ...
 */
/*@{*/
#define hsFileCPhone					'HsPh'	  // Yes : Phone core application
#define hsFileCPhone2					'HsP2'	  // Yes : Phone core application version 3.0
#define hsFileCPhoneStub68k				'Pm68'    // Yes : Phone 68k stub app for calling 68k libraries that do UI
#define hsFileCPhoneMainView				'PmPm'	  // Yes : Phone Main view
#define hsFileCPhoneDialPadView				'PmPd'	  // Yes : Phone Dial Pad view
#define hsFileCPhonePeopleView				'PmPp'	  // Yes : Phone People view
#define hsFileCPhoneFavoritesView			'PmPf'	  // Yes : Phone Favorites view
#define hsFileCPhoneCallLogView				'PmPl'	  // Yes : Phone Call Log view
#define hsFileCPhoneActiveCallView			'PmPa'	  // Yes : Phone Active Call view
#define hsFileCPhoneIncomingCallView			'PmPi'	  // Yes : Phone Incoming Call view
#define hsFileCPhoneAppFavoritesLibrary		'PmPF'		// Yes: Phone Application Favorites library
...
#define hsFilePhoneBluetoothConnect     'PhBt'    // Yes : Phone - Bluetooth (Connect headset)
/*@}*/
...
// <chg 2005-NOV-10 Monte Benaresh> Added next define
#define pmTSCalToken					'TScb'	//	Yes: Token used to store
												// the touchscreen calibration.
												// Used by Welcome App
												// (SetupPhone) starting with
												// Ventura/Camino
// <chg 2005-NOV-14 Monte Benaresh> Added next define
#define pmKbdLayoutToken				'KBlo'	// Yes: Token to store the keyboard
												// layout. Used by Welcome App
												// (SetupPhone) starting with
												// Ventura/Camino

// <chg 2006-MAR-31 Monte Benaresh> Added next define - bug 154466
#define pmTSTokenValidToken				'TStv'	// Yes: Token whose presence
												// indicates that the TScb token
												// should be used (see above).
												// Used by Welcome App
												// (SetupPhone) starting with
												// Ventura/Camino. Size = 2 bytes
