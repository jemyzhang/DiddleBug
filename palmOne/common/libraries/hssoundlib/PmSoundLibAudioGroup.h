 ...
 * @brief	Public 68K header file used to associate sound channels with Audio
 ...
 ***********************************************************************/
#include <HsSoundLibCommon.h> /**<Included for hsSoundLibCreatorID. */
...
typedef enum PmAudioGroupEnum
{
	...
	pmAudioGroupInteractive  = 0x6004, /**<Application audio to be used for interactive playback (eg: games). */
	pmAudioGroupStreaming    = 0x6005, /**<Application audio to be used for streaming (eg: MP3, video, broadcast). */
	pmAudioGroupCall         = 0x6006, /**<Intended for digital phone call audio only. Used for internal purposes. */
	pmAudioGroupAlertRingOff = 0x6007  /**<Same as pmAudioGroupAlert, but ignores Ringer switch position */
 ...
 */
/*@{*/
#define PmSndAddAudioGroupToVolume(volume,audioGroup)  (Int32)       (((!audioGroup) || (((Int32)(volume)) <= -1))? (volume) : ((((((volume) & 0xE000) == 0x6000)? (volume):(volume)+7) & ~PM_AUDIOGROUP_MASK) | (audioGroup)))/**<Attaches an audio group designation to a PalmOS volume parameter.
