...
#define kPmKeyLibAPIMajorVersion	3	/**< Major version incremented when API
											 changes */
...
{ 
  ...
  pmKeyAttrGetLauncherKeyCode,  /**< Returns the key code for the Launcher key */
  pmKeyAttrGetMenuKeyCode,		/**< Returns the key code for the Menu key */
  pmKeyAttrGetSendKeyCode,		/**< Returns the key code for the Send key */
  pmKeyAttrGetEndKeyCode,		/**< Returns the key code for the End key */
  pmKeyAttrGetPhoneKeyCode		/**< Returns the key code for the Phone key */

  /*
   * End of enums in API version 3
   */
