 ...
 * @brief		This library provide support for displaying YCbCr images directly
 *				on the screen.
 *
 * Note that the image that is drawn on the screen will always sit on top of the
 * form above everything else.
 *
 * @{
 * @}
 */
 ...
 * @version 1.0
 * @brief   Public 68k common header file for LCDOverlay API.
 *
 ...
 * @see LcdOverlayLibSettingTag
 */
typedef struct LcdOverlayLibSettingTag		LcdOverlayLibFormatType;

/**
 * @name Data Formats
 * @brief Format types for overlay.
 *
 * Not all of the formats may be supported, please do a query to find
