...
enum _ToneVibrateType
{
  ...
  /* We are reserving the upper 2 bits in the ToneVibrateType for tone interrupt mode information */
  toneInterruptPhone = 64,	/**< Interrupt mode for phone '01' in upper two bits */
  toneInterruptMode2 = 128, /**< Reserved interrupt mode  '10' in upper two bits */
  toneInterruptMode3 = 192, /**< Reserved interrupt mode  '11' in upper two bits */
};
...
/**
 * @brief  Structure for network related sounds.
 */
typedef struct {
	Boolean signalFadedTone;
	Boolean eriStatusTone;
} SoundPreferenceNetworkSounds;
	...
	union _tonePrefs
	  {
		...
		SoundPreferenceNetworkSounds  networkSoundPrefs;	/**<No definition. */
...
#define		  tonesLibTrapEscalateRingTones	sysLibTrapCustom+20/**<Trap ID for function to set/query ringtone escalation. */
#define		  tonesLibTrapPlayRingTone		sysLibTrapCustom+21/**<Trap ID for function to play a ringtone. */
#define		  tonesLibTrapSaveUndeletableTones		sysLibTrapCustom+22 /**<Trap ID for function to create backup db. */
#define		  tonesLibTrapCopyBackUndeletableTones	sysLibTrapCustom+23 /**<Trap ID for function to copy undeletable tones back. */
