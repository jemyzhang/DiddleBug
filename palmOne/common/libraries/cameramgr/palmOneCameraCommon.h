...
#define kCamLibCtrlColorSpaceSet			0x66/**< Sets the Color Space. Parameter is CamLibColorSpaceType*.*/
#define kCamLibCtrlColorSpaceGet			0x67/**< Gets the Color Space. Parameter is CamLibColorSpaceType*.*/
#define kCamLibCtrlColorSpaceQuery			0x68/**< Queries for the Color Space. Parameter is CamLibColorSpaceType*.*/
#define kCamLibCtrlShutterSpeedSet			0x69/**< Sets the Shutter Speed. Parameter is CamLibShutterSpeedType*.*/
#define kCamLibCtrlShutterSpeedGet			0x6A/**< Gets the Shutter Speed. Parameter is CamLibShutterSpeedType*.*/
#define kCamLibCtrlShutterSpeedQuery		0x6B/**< Queries for the Shutter Speed. Parameter is CamLibShutterSpeedType*.*/
#define kCamLibCtrlApertureValueSet			0x6C/**< Sets the Aperture Value. Parameter is CamLibApertureValueType*.*/
#define kCamLibCtrlApertureValueGet			0x6D/**< Gets the Aperture Value. Parameter is CamLibApertureValueType*.*/
#define kCamLibCtrlApertureValueQuery		0x6E/**< Queries for the Aperture Value. Parameter is CamLibApertureValueType*.*/
/*@}*/
...
/**
 * @brief Color Space structure.
 */
typedef struct CamLibColorSpaceTag
{
	Int32 value;		/**< Value. */

} CamLibColorSpaceType;
...
/* By definition, SXGA is 1280x1024, but someone erroneously defined
 * kCamLibImageSizeSXGA as 1280x960.  kCamLibImageSizeSXGA is now
 * deprecated, in favor of two new contstants.
 */

#define kCamLibImageSizeSXGA960             0x10/**< 1280x 960 High Resolution. */
#define kCamLibImageSizeSXGA1024            0x80/**< 1280x 1024 High Resolution. */
/*@}*/
...
/**
 * @name Color Space Settings
 */
/*@{*/
#define kCamLibColorSpace_sRGB          0x02/**< color space sRGB. */
#define kCamLibColorSpaceUncalibrated   0x04/**< color space uncalibrated. */
/*@}*/

/**
 * @name Shutter Speed Settings
 */
/*@{*/
#define kCamLibShutterSpeedManual		0x01/**<Sets the shutter speed manually through an additional
                                                 passed parameter with kCamLibCtrlShutterSpeedSet.*/
#define kCamLibShutterSpeedAuto			0x02/**<Sets the shutter speed automatically.*/
/*@}*/

/** @see CamLibSettingTag */
typedef struct CamLibSettingTag CamLibShutterSpeedType;

/**
 * @name Aperture Value Settings
 */
/*@{*/
#define kCamLibApertureValueManual		0x01/**<Sets the aperture value manually through an additional
                                                 passed parameter with kCamLibCtrlApertureValueSet.For manual
                                                 values, all values are x1000 of real aperture value
                                                 i.e. ap val 1.4 is 1400.*/
#define kCamLibApertureValueAuto		0x02/**<Sets the aperture value automatically.*/
/*@}*/

/** @see CamLibSettingTag */
typedef struct CamLibSettingTag CamLibApertureValueType;
