 ...
 ******************************************************************************/
/**
 * @defgroup	Locs Locations Library
 * @brief		This library provides location/timezone/DST support for applications.
 *
 * Developers who want to provide location/timezone/DST or country information
 * to their application on Palm devices should use Locations Library API.
 *
 * @{
 * @}
 */
...
/**
 * @file	LocsLibCommon.h
 * @brief	Public 68K common header file for locations library.
 *
...
#define kLocNoDisplayInCustom       (UInt8)(0) /**< don't display location in custom database */
#define kLocDisplayInCustom         (UInt8)(1) /**< display location in custom database */

//Undefined position
#define kUndefinedPosition			(Int16)999 /**< flag: position of location in database in undefined */
...
#define kLocDBVersion               (UInt16)(2)					/**< Current version of the location DB format */
#define kLocDBMaxLocNameLength      kLocNameMaxLength   /**< Max # of bytes for a location name stored. */

/**
 *@name Database Names and Types
 */
/*@{*/ 
...
#define kLocDBTypeDefault           (UInt8)(0) /**< the location database is the default one */
#define kLocDBTypeCustom            (UInt8)(1) /**< the location database is custom */
...
/** Container to store degree and minute of a coordinate */
typedef struct{
				Int16	degree;
				Int16	minute;
			   }Coordinate;

/** Container to store longitude and latitude of a specific location */
typedef struct{
				Coordinate	latitude;
...
{
    Int16       uTC;		 	 		 							/**< timezone */
    DSTType     dSTStart;										/**< date/time when DST begins, e.g. 31 Oct 2am */
    DSTType     dSTEnd;											/**< date/time when DST end */
    Int16       dSTAdjustmentInMinutes;  		/**< 0 = DST not observed, 60 = observed. */
    CountryType country;										/**< see Palm OS documentation for values */
    UInt8       custom   : 1,								/**< not used */
                reserved : 7;								/**< not used */
...
/** Helpful struct for passing db info as an argument */
struct LocDBInfoTag
{
    Char*  dbName; 		 				 /**< name of location database */
    UInt32 dbCreatorID;				 /**< creator of the database */
    UInt32 dbType;						 /**< database type */
    UInt16 dbCardNum;					 /**< cardNo where database resides */
};
...
{
    Int16       uTC; 				 										/**< timezone */
    DSTType     dSTStart;												/**< time when DST begins e.g. 2am */
    DSTType     dSTEnd;													/**< time when DST end */
    Int16       dSTAdjustmentInMinutes;  				/**< 0 = DST not observed, 60 = observed. */
    CountryType country;												/**< Country. See Palm OS documentation for values */
    UInt8       custom   : 1,										/**< not used */
                reserved : 7;										/**< not used */
    Char        name[0];          							/**< LocationType uses Char* name */
};
...
{
	LocationType locationDataNew;			 /**< new location data */
	const Char*  locationNameOldP;		 /**< name of old location */
};
...
/** Container for the selected location in the location database */
struct LocsLibSelLocsTag
{
    ...
    UInt8         reserved;						/**< Reserved, not used */
