...
#define P1clErrFailedToEmptyDatabase	(P1clErrorClass | 46)
...
typedef UInt8 P1clListFieldType;
...
typedef UInt8 P1clTimeZoneType;
...
enum _P1clFieldsTypes
{
	...
	P1clTzLocName,
	P1clApptStatus,
	P1clMaxCategoryLength,
	P1clNumFields
};

typedef UInt8 P1clFieldTypes;
...
typedef UInt8 P1clAttendeeRoleType;
...
typedef UInt8 P1clAttendeeFieldType;
...
typedef UInt8 P1clApptStatusType;
...
typedef Boolean	(* DateBookCompAttachFucPtr) (void*	pSource, void *SearchString);
	...
	#define	P1clTrapDeleteOldAndDuplicates			(sysLibTrapCustom + 136)		
	#define P1clTrapAccountResetServerId			(sysLibTrapCustom + 137)
	#define P1clTrapAddLocalToTransactionLog		(sysLibTrapCustom + 138)
	#define P1clTrapSortCalendarSpecial				(sysLibTrapCustom + 139)
	#define P1clTrapTxnIsKnownDataSource			(sysLibTrapCustom + 140)
	#define P1clTrapSetServerIdByUniqueID			(sysLibTrapCustom + 141)
	#define P1clTrapPerformPostSyncFunctions		(sysLibTrapCustom + 142)
