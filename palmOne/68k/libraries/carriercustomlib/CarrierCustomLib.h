 ...
 * @author       dla
 *
 * $Id: //depot/Components/Libraries/PmCarrierCustomizationLib/1.2C/Incs/IncsPublic/68K/Libraries/PmCarrierCustomizationLib/CarrierCustomLib.h#1 $
 *
 */
...
#define MVNONAME_LENGTH 10  /* length for MVNO name stored in carrier DB*/
