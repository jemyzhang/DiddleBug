 ...
 * @version 1.0
 * @brief This file contains the FileBrowser Library APIs
 *
 */
...
/// @param defaultExtension		IN: default extension to display initially
/// @param fileType:		IN: optional MIME type or extension to get
///                 		    default directory on each volume
/// @param title:			IN: open dialog title
...
/// @param filePathP:	OUT: pass back the file's path
/// @retval Err Error code
