...
Boolean HtmlLibResetFocusInfo(UInt16 refnum, MemHandle htmlLibH)
		SYS_TRAP(kHtmlLibTrapResetFocusInfo);
void HtmlLibSetFocusStatus(UInt16 refnum, MemHandle htmlLibH, Boolean flag, Boolean reset_focus)
		SYS_TRAP(kHtmlLibTrapSetFocusStatus);
