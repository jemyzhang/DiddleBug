...
#define kHtmlLibTrapGetTargetInfo			(sysLibTrapCustom + 27)
#define kHtmlLibTrapInitializeWithHeapSize	(sysLibTrapCustom + 28)
#define kHtmlLibTrapSetImageMemoryLimit		(sysLibTrapCustom + 29)
#define kHtmlLibTrapResetFocusInfo			(sysLibTrapCustom + 30)
#define kHtmlLibTrapSetFocusStatus			(sysLibTrapCustom + 31)
