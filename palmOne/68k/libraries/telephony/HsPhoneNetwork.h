 ...
 *  @retval 0 for success; otherwise failed.
 **/
extern Err PhnLibBoxInformationEx (UInt16 refNum, PhnMsgBoxDataType *data, Boolean bGetInfo)
 ...
 **/
extern Err PhnLibGetEnhancedRoamIndicator (UInt16 refNum, char * roamTxt, PhnRoamIconState *iconState)
 ...
 *
 *  @param refNum:  IN:  Library reference number returned by HsGetPhoneLibrary().
 *  @param Mode:    IN:  see PhnRoamPrefSelectionType
 *  @retval Err Error code.
 **/
extern Err PhnLibGetRoamPrefMode (UInt16 refNum, PhnRoamPrefSelectionType *roamPrefP)
 ...
 *  @retval Error status
 **/
extern Err PhnLibSetRoamPrefMode (UInt16 refNum, PhnRoamPrefSelectionType roamPref)
...
/**
 *  @brief Returns the current state of the data session as well as the available
 *         data session type currently available on the network.
 *
 *  @param refNum:              IN:  Library reference number returned by HsGetPhoneLibrary().
 *  @param dataSessionStateP:  OUT:  data structure to be filled out. version field must be set
 *  @retval 0 for success; otherwise failed
 **/
extern Err PhnLibGetDataSessionInfo(UInt16 refNum, PhnDataSessionStateType *dataSessionStateP)
           PHN_LIB_TRAP(PhnLibTrapGetDataSessionInfo);
