 ...
 *  
 *  @param refNum:	IN:  
 *  @param noiseCancellationP:	IN:   
 *  @retval Err Error code.
 **/
extern Err PhnLibGetNoiseCancellation(UInt16 refNum, Boolean* noiseCancellationP)
			  PHN_LIB_TRAP(PhnLibTrapGetNoiseCancellation);

/**
 *  @brief 
 *  
 *  @param refNum:	IN:  
 *  @param noiseCancellation:	IN:   
 *  @retval Err Error code.
 **/			  
extern Err PhnLibSetNoiseCancellation(UInt16 refNum, Boolean noiseCancellation)
			  PHN_LIB_TRAP(PhnLibTrapSetNoiseCancellation);

/**
 *  @brief 
 *  
 *  @param refNum:	IN:  
 *  @param bufferP:	OUT: contains MEID or ESN (for non-MEID devices) 
 *  @retval Err Error code.
 **/			  
extern Err PhnLibGetMEID (UInt16 refNum, CharPtr *bufferP)
    PHN_LIB_TRAP (PhnLibTrapGetMEID);
