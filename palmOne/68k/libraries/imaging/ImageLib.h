...
/**
 * @file  ImageLib.h
 * @brief Public 68k include file for the Imaging Library.
 *
 ...
 * @param   fileName:			OUT: If the user selects an image from the VFS system, the full path of the file will be copied into fileNameP. fileName should be capable of holding the largest possible VFS filename. If the user does not select a VFS file, fileName[0] will be NULL.
 ...
 *
 * @code void callback(Int32 progress, Int32 max, Int8 operation);@endcode
 *
 * @param   libRef:		IN:  Library reference number.
 ...
 * @param   containerIDP:	IN: Container ID.
 * @retval  Err 0 on success, non-zero on error.
 *
 ****************************************************************/
 ...
 * @param   libRef:				IN:  Library reference number.
 * @param   recIndex:			IN:  Index of image.
 * @param   width:				IN,OUT: On output, contains the width of the image. On input, if fitToDimensions is true, determines the max width that the image should be.
 * @param   height:			IN,OUT: On output, contains the height of the image. On input, if fitToDimensions is true, determines the max height that the image should be.
 ...
 *
 * @param   libRef:       IN:  Library reference number.
 * @param   value:      IN:  new compression quality.
 * @retval  Err 0 on success, non-zero on error.
 *
 ****************************************************************/
