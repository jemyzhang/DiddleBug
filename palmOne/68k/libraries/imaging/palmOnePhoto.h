 ...
 *  - The notion of Unfiled folder has been removed
 *  - In PalmPhotoDeleteAlbum() setting the parameter moveToUnfiled
 *    moves the photos in the deleted album to DCIM/Palm instead of 
 *    the Unfiled folder which was DCIM. 
 */
 ...
 * @param moveToUnfiled:	IN: If true, photos from the deleted album are moved to /DCIM/Palm
 *                              folder. Otherwise, they are deleted. In previous versions
 *                              the Unfiled album was mapped to the /DCIM folder.
 * @retval					Err Error code.
 */
 ...
 *
 * @param refNum:	IN: Library reference number.
 * @param albumID:	IN: ID of the Album to retrieve information from.
 * @retval			Err Error code.
 */
 ...
 * If album doesn't exist, the image will be added to the album named "Palm". In the previous
 * versions if the album did not exist, the image was added to the "Unfiled" album. 
 * Passing albumID of PALM_PHOTO_ALBUM_ALL results in the image being added
 * to the "Palm" album. In the previous versions passing albumID of 
 * PALM_PHOTO_ALBUM_ALL resulted in the image being added to the "Unfiled" album.
 * For compatibility only; new development should use the V2 version.
 *
 * @param refNum:		IN:  Library reference number.
