...
/// @endcode
///
///	Note that there are new attributes added for version 3 of the
/// PmKeyAttrGet() function, so it is highly recommended that any 
/// application that calls this function does one or both of the 
/// following:
///  
/// Check the return code.  If its hsErrNotSupported, then the attribute
/// that the function is looking for is NOT SUPPORTED using that particular
/// version of the library!
/// 
///  - OR -
/// 
/// Check the version number of the PmKeyLib. To do this, load the PmKeyLib 
/// and then get the feature with creator = kPmKeyLibCreator and featureNum = 
/// kPmKeyLibFtrValAPIVersion.  Note that if the feature does not exist (and 
/// the library successfully loaded), they can assume that it's version 1.0 
/// of PmKeyLib.  If the feature does exist, then perform a check similar to 
/// the following:
/// 
/// @code
