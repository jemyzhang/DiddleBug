 ...
 * status.  This permits internal record "loaders" to initialize record
 ...
 * to receive the field ID's of all fields in the field set.
 ...
 * to quickly determine if synchronization is necessary, and skip it if not.
