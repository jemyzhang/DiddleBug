...
/** NetPrefFallbackInfoType -- Fallback Info: algorithm and status.
...
/** <chg 2006-01-18 kos> Feature for Camino|Microwave: Per-APN proxy settings (9.1.2)
 *  deprecates the old "browser settings" normally stored in the carrier record
 */
	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyPrimaryHttpServer,  30,  \
				netPrefFieldTypeStr,  0, 0,  <30:HttpSv>, 11 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyPrimaryHttpPort,  31,  \
				netPrefFieldTypeUInt32,  0, 0,  <31:HttpPt>, 11 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyPrimaryHttpsServer,  32,  \
				netPrefFieldTypeStr,  0, 0,  <32:HttpsSv>, 12 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyPrimaryHttpsPort,  33,  \
				netPrefFieldTypeUInt32,  0, 0,  <33:HttpsPt>, 12 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxySecondaryHttpServer,  34,  \
				netPrefFieldTypeStr,  0, 0,  <34:HttpS2>, 11 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxySecondaryHttpPort,  35,  \
				netPrefFieldTypeUInt32,  0, 0,  <35:HttpP2>, 11 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxySecondaryHttpsServer,  36,  \
				netPrefFieldTypeStr,  0, 0,  <36:HttpsS2>, 12 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxySecondaryHttpsPort,  37,  \
				netPrefFieldTypeUInt32,  0, 0,  <37:HttpsP2>, 12 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyExcludedHostsString,  38,  \
				netPrefFieldTypeStr,  0, 0,  <38:ExclHst>, 12 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyUsernameNew,  39, \
				netPrefFieldTypeStr,  0, 0,  <39:User2>, 10 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyPasswordNew,  40,  \
				netPrefFieldTypeStr,  0, 0,  <40:Pass2>, 10 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyReqCustomUaProf,  41,  \
				netPrefFieldTypeUInt8,  0, 0,  <41:CustUa>, 11 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyDefaultHomePage,  42,  \
				netPrefFieldTypeStr,  0, 0,  <42:HomePg>, 11 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyUaProfHostedOnOwnServers,  43,  \
				netPrefFieldTypeUInt8,  0, 0,  <43:UaOwnSv>, 12 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyUrlOfUaProfFile,  44,  \
				netPrefFieldTypeStr,  0, 0,  <44:UrlUa>, 10 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyEncryptedMsisdn,  45,  \
				netPrefFieldTypeUInt8,  0, 0,  <45:EncrMSI>, 12 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyMsisdnFormat,  46,  \
				netPrefFieldTypeStr,  0, 0,  <46:MSIfmt>, 11 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyMsisdnStaticString,  47,  \
				netPrefFieldTypeStr,  0, 0,  <47:MSIStr>, 11 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyReqStaticHeaderString,  48,  \
				netPrefFieldTypeUInt8,  0, 0,  <48:ReqStat>, 12 )

	NetPrefRecFieldInfoExtended( netPrefRecFieldProxyStaticHeaderString,  49,  \
				netPrefFieldTypeStr,  0, 0,  <49:StatHStr>, 13 )

  // ivoj: 
  // char*, URL filtering
  NetPrefRecFieldInfoExtended(	netPrefRecFieldDomain01, 50, \
			  netPrefFieldTypeStr,	  0, 0, <50:domain01>, 13)
			  
  // ivoj: 
  // char*, URL filtering
  NetPrefRecFieldInfoExtended(	netPrefRecFieldDomain02, 51, \
			  netPrefFieldTypeStr,	  0, 0, <51:domain02>, 13)
			  
  // ivoj: 
  // char*, URL filtering
  NetPrefRecFieldInfoExtended(	netPrefRecFieldDomain03, 52, \
			  netPrefFieldTypeStr,	  0, 0, <52:domain03>, 13)
			  
  // ivoj: 
  // char*, URL filtering
  NetPrefRecFieldInfoExtended(	netPrefRecFieldDomain04, 53, \
			  netPrefFieldTypeStr,	  0, 0, <53:domain04>, 13)
			  
  // ivoj: 
  // char*, URL filtering
  NetPrefRecFieldInfoExtended(	netPrefRecFieldDomain05, 54, \
			  netPrefFieldTypeStr,	  0, 0, <54:domain05>, 13)
			  
  // ivoj: 
  // char*, URL filtering
  NetPrefRecFieldInfoExtended(	netPrefRecFieldDomain06, 55, \
			  netPrefFieldTypeStr,	  0, 0, <55:domain06>, 13)
			  
  // ivoj: 
  // char*, URL filtering
  NetPrefRecFieldInfoExtended(	netPrefRecFieldDomain07, 56, \
			  netPrefFieldTypeStr,	  0, 0, <56:domain07>, 13)
			  
  // ivoj: 
  // char*, URL filtering
  NetPrefRecFieldInfoExtended(	netPrefRecFieldDomain08, 57, \
			  netPrefFieldTypeStr,	  0, 0, <57:domain08>, 13)
			  
  // ivoj: 
  // char*, URL filtering
  NetPrefRecFieldInfoExtended(	netPrefRecFieldDomain09, 58, \
			  netPrefFieldTypeStr,	  0, 0, <58:domain09>, 13)
			  
  // ivoj: 
  // char*, URL filtering
  NetPrefRecFieldInfoExtended(	netPrefRecFieldDomain10, 59, \
			  netPrefFieldTypeStr,	  0, 0, <59:domain10>, 13)
 ...
 *  "CloseWait" setting is used to control NetLib's CloseWait behavior
 *  only.
 */
...
/** char*; phone number; corresponds to the Phone # field in the Phone Setup dialog. */
